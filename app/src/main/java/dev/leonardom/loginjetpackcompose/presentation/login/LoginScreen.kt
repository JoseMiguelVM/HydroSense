                        ...
                        Column(
                            ...
                            ClickableText(
                                text = buildAnnotatedString {
                                    append("Aun no tiene una cuenta?  ")
...
// Linea de codigo para visualizar UI en jetpack compose
@Preview
@Composable
fun PreviewLoginScreen() {
    ...
    LoginScreen(
        state = state,
        onLogin = { email, password -> /* Lógica de inicio de sesión */ },
        onNavigateToRegister= { /* Lógica para navegar a la pantalla de registro */ },
        onDismissDialog= { /* Lógica para descartar el diálogo de error */ }
    )
}
